...
import { saveGame, saveBatch, listBatches } from "@/lib/file-store";
          ...
          [
            {
              ...
              level: "info",
              code: null,
              message: `Game built: ${mechanic} seed=${jobSeed}`,
              meta: { mechanic, productIds, seed: jobSeed },
              createdAt: nowIso,
            },
          ]
        );
        ...
        saveGame(
          {
            ...
            outputPath: null,
            captionJson: null,
            validatorErrors: [{ code: "BUILD_ERROR", hint: errMsg }],
            planningMs: 0,
            renderMs: 0,
            createdAt: nowIso,
            updatedAt: new Date().toISOString(),
